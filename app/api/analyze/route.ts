...
const itemSchema = {
  ...
  properties: {
    ...
    paid_with_card: {
      type: "string",
      description: "ชื่อบัตรเครดิต/หนี้ของฉันที่ใช้จ่ายรายการนี้ ใช้เฉพาะ transaction_type เป็น split_half หรือ lend ถ้าจ่ายด้วยเงินในกระเป๋าหรือไม่ระบุ ให้ส่งค่าว่าง",
    },
    partner_share: {
      type: "number",
      minimum: 0,
