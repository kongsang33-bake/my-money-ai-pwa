  ...
  return [
    ...
    ...(hasImages
      ? [
          ...
          "- ถ้าสินค้าบนสลิปอยู่คนละหมวดหมู่กัน ห้ามรวมเป็นรายการเดียวหมวดเดียว ให้แยกเป็นหลายรายการตามหมวดหมู่",
          "- สินค้าที่อยู่หมวดหมู่เดียวกันในสลิปเดียวกัน ให้รวมยอดเป็นรายการเดียวได้",
          "- ยอดรวมของทุกรายการที่แยกจากสลิปเดียวกัน ต้องบวกกันได้เท่ากับยอดสุทธิที่ระบุบนสลิป",
          "- ตั้ง title ให้สื่อถึงสินค้าที่ซื้อจริงในรายการนั้น (เช่น ชื่อสินค้าหลัก หรือกลุ่มสินค้า) ไม่ใช่แค่ชื่อร้าน",
          "",
        ]
      : []),
