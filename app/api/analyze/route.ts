...
function buildPrompt(
  ...
  return [
    ...
    "",
    "กติกา paid_with_card (จ่ายด้วยบัตรเครดิตแต่ไม่ได้จ่ายเองคนเดียว):",
    ...
    "- ถ้าชื่อบัตรที่พูดถึงไม่มีอยู่ในรายชื่อหนี้ของฉัน หรือจ่ายด้วยเงินในกระเป๋า ให้ส่ง paid_with_card เป็นค่าว่าง",
    "",
