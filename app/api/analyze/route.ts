...
const itemSchema = {
  ...
  properties: {
    ...
    partner_share: {
      type: "number",
      minimum: 0,
      description: "ยอดที่อีกฝ่ายต้องคืน ใช้เฉพาะ transaction_type เป็น split_half ถ้าหารครึ่งเท่ากันหรือไม่ได้ระบุสัดส่วน ให้ส่ง 0 แล้วแอพจะหารครึ่งเอง",
    },
    ambiguous: {
      type: "boolean",
  ...
  required: ["title", "category", "amount", "transaction_type", "debtor_name", "date", "note", "wallet_id", "transfer_to_wallet_id", "paid_with_card", "partner_share", "ambiguous"],
