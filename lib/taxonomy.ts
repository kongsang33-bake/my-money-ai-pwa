...
export const DEBT_TYPES: TransactionType[] = ["lend", "split_half", "debt_repayment", "debt_payment", "card_charge"];

// Debt the user owes someone else (credit cards, personal debt payments).
export const TYPES_USER_OWES: TransactionType[] = ["debt_payment", "card_charge"];
