import { APP_NAME, PRIVACY_POLICY_VERSION } from "@/lib/constants";
  ...
  return (
    <div className="privacy-policy">
      ...
      <p>
        ...
        ส่งให้ใครบ้าง และคุณจัดการข้อมูลของตัวเองได้อย่างไร
      </p>
      ...
      <section>
        ...
        <p>
          ใช้แสดงและคำนวณยอดเงินในแอพให้คุณเท่านั้น ไม่มีโฆษณา ไม่มีตัวติดตามพฤติกรรม
      ...
      <section>
        ...
        <ul>
          ...
          <li>ถ้าต้องการให้ลบบัญชีและข้อมูลทั้งหมด แจ้งผู้พัฒนาได้ แล้วเราจะลบให้</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          ถ้าเนื้อหาของนโยบายนี้เปลี่ยน แอพจะขอให้คุณอ่านและกดรับทราบอีกครั้งก่อนเข้าสู่ระบบครั้งถัดไป
        </p>
      </section>
    </div>
  );
