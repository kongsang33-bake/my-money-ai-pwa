...
const updatedLabel = new Intl.DateTimeFormat("th-TH", { dateStyle: "long", timeZone: "Asia/Bangkok" })
  // The version is the date it changed, with ".2" and on for a second change
  // on the same day; the date part is what the page shows.
  .format(new Date(`${PRIVACY_POLICY_VERSION.slice(0, 10)}T00:00:00+07:00`));
    ...
    <div className="privacy-policy">
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <b>กระเป๋าการ์ด</b> ชื่อการ์ด เลขพร้อมเพย์ (เบอร์โทรหรือเลขบัตรประชาชน) เลขบัญชีและชื่อธนาคาร
            เลขบาร์โค้ดและข้อความใน QR ของบัตรหรือตั๋ว รายละเอียดตั๋ว (ชื่องาน สถานที่ วันเวลา ที่นั่ง)
            ผู้ออกบัตร และชื่อเจ้าของที่คุณกรอกเอง ข้อมูลที่เก็บไว้เหล่านี้ไม่ถูกส่งให้ AI
          </li>
        ...
        <p>
          รูปที่เลือกในกระเป๋าการ์ดถูกอ่าน QR หรือบาร์โค้ดในเครื่องของคุณ แอพเก็บแค่ข้อความในโค้ด ตัวรูปไม่ถูกเก็บ
          ยกเว้นเมื่อคุณกด &ldquo;ให้ AI ช่วยกรอก&rdquo; กับบัตรหรือตั๋ว รูปนั้นจะถูกส่งไปให้ Google Gemini
          อ่านรายละเอียดที่พิมพ์อยู่ แล้วเติมลงแบบฟอร์มให้คุณตรวจก่อนบันทึก แอพไม่เก็บรูปนั้นไว้
          และไม่มีปุ่มนี้กับพร้อมเพย์ QR รับเงิน หรือบัญชีธนาคาร
          เมื่อคุณแชร์การ์ดเป็นรูป รูปนั้นสร้างในเครื่องและไปถึงเฉพาะแอพหรือคนที่คุณเลือกส่งเท่านั้น
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <b>Google Gemini</b> เมื่อคุณใช้ AI จดรายการ แนบสลิป ถามคำถาม หรือให้ AI ช่วยกรอกรายละเอียดบัตรหรือตั๋ว ข้อความหรือรูปนั้น
