  ...
  return (
    <div className="privacy-policy">
      ...
      <section>
        ...
        <p>
          เก็บไว้ตราบเท่าที่บัญชีของคุณยังอยู่ เมื่อคุณขอให้ลบบัญชี ข้อมูลทั้งหมดของบัญชีนั้น
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ถ้าต้องการใช้สิทธิ์อื่น เช่น ให้ลบบัญชีและข้อมูลทั้งหมด หรือมีคำถามเรื่องข้อมูลส่วนตัว อีเมลถึงผู้พัฒนาที่{" "}
            <a href={`mailto:${PRIVACY_CONTACT_EMAIL}`}>{PRIVACY_CONTACT_EMAIL}</a>
          </li>
        </ul>
      </section>
